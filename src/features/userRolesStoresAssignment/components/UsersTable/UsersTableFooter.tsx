...
export const UsersTableFooter = memo<UsersTableFooterProps>(({
  loading,
  users,
  pagination,
  currentPage,
  ...
  return (
    <div className="px-4 py-3 border-t bg-card flex flex-col lg:flex-row items-center justify-between gap-4">
