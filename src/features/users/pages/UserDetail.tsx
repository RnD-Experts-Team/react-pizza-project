...
const ViewUserPage: React.FC = () => {
    ...
    return (
      ...
      >
        <div className="flex items-center justify-center py-8 sm:py-10 md:py-12 lg:py-16">
          <Loader2
            className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 animate-spin"
  ...
  if (error || !user) {
    return (
      ...
      >
        <div
          className="text-center py-3 sm:py-4 text-sm sm:text-base"
      ...
      >
        <CardContent className="pt-4 sm:pt-5 md:pt-6 p-4 sm:p-5 md:p-6">
          <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
            <div
              className="h-16 w-16 sm:h-18 sm:w-18 md:h-20 md:w-20 rounded-full flex items-center justify-center text-lg sm:text-xl md:text-2xl font-bold mx-auto sm:mx-0"
              style={{
        ...
        >
          ...
          <CardContent className="space-y-3 sm:space-y-4 p-4 sm:p-5 md:p-6">
            ...
            <div>
              ...
              <p
                className="text-sm sm:text-base mt-1 flex items-center gap-2"
                style={{ color: 'var(--card-foreground)' }}
              >
                <Calendar
